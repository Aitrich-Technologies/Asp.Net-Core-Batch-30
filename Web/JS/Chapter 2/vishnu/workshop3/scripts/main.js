var applicantList = [
    { name: "Alex", image: "images/m1.png", place: "Thrissur", quali:"Btech",  experience: "2 years"  },
    { name: "Ameya", image: "./images/m2.png",  place: "Palakkad", quali:"MCA",  experience: "2 years"  },
    { name: "Ommer", image: "./images/m1.png", place: "Kochi", quali:"BCA",  experience: "4 years"  },
];
listApplicants();
function listApplicants() {
   ...
   for(let value in applicantList) {
        ...
        quali.textContent=applicantList[value].quali;
