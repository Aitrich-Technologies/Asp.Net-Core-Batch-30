...
public class Program
{
    public static void Main()
    {
        ...
        Console.WriteLine("Any mark > 85: " + anyHighMark);
        ...
        Console.WriteLine("First mark < 50: " + firstLowMark);

        
        var highSalaryEmp = employees.FirstOrDefault(e => e.Salary > 55000);
        Console.WriteLine("First employee salary > 55000: " + highSalaryEmp?.Name);
        ...
        Console.WriteLine("Marks > 60 List: " + string.Join(", ", highMarksList));
